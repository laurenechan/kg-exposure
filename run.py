...
import click
from kg_pegs import download as kg_download
from kg_pegs import transform as kg_transform
from kg_pegs.merge_utils.merge_kg import load_and_merge
...
def transform(*args, **kwargs) -> None:
    """Calls scripts in kg_pegs/transform/[source name]/ to transform each source
