...
LOCAL_TABLE = "./kg_pegs/transform_utils/pegs_surveys_exposomeA/translation_map_expA.yaml"
...
class PegsSurveysTransform(Transform):
    ...
    def parse(self, name: str, data_file: str, source: str) -> None:
        ...
        config = os.path.join("kg_pegs/transform_utils/pegs_surveys_exposomeA/",
                              PEGS_CONFIGS[source])
