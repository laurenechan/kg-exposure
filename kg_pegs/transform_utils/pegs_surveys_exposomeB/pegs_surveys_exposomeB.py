...
PEGS_SOURCES = {
    ...
    'subject2medication': 'testEPRsubject2medication.csv'
}

PEGS_CONFIGS = {
    'survey_respondent': 'survey_respondents.yaml',
    'subject2exposure': 'subject2exposure.yaml',
    'subject2medication': 'subject2medication.yaml'
}


TRANSLATION_TABLE = "./kg_pegs/transform_utils/translation_table.yaml"
LOCAL_TABLE = "./kg_pegs/transform_utils/pegs_surveys_exposomeB/translation_map_expB.yaml"
...
class PegsSurveysTransform(Transform):
    ...
    def parse(self, name: str, data_file: str, source: str) -> None:
        ...
        config = os.path.join("kg_pegs/transform_utils/pegs_surveys_exposomeB/",
                              PEGS_CONFIGS[source])
