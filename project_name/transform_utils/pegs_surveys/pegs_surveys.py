...
REACTOME_SOURCES = {
    'subject2phenotype': 'testPatientEpr_he.csv', #make a small 400 column test patient
}
...
class PegsSurveysTransform(Transform):
    ...
    def parse(self, name: str, data_file: str, source: str) -> None:
        ...
        config = os.path.join("project_name/transform_utils/pegs_surveys/", REACTOME_CONFIGS[source])
